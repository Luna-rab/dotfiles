...
def locked_worktrees() -> dict[str, str]:
...
def run_worktrees(run_id: str) -> list[str]:
    ...
    return sorted(p for p in listed_worktrees() if os.path.basename(p).startswith(prefix))
